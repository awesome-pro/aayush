...
const RAPIDAPI_KEY = process.env.NEXT_PUBLIC_CHATGPT_API;
...
export default function Home() {
  ...
  const handleUserInput = async () => {
    ...
    try {
      ...
      setChatHistory((prevChat : any) => [...prevChat, newAssistantMessage]);
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center">
      <div className="w-full max-w-screen-md bg-white p-4 rounded-lg shadow-md my-8">
        <div className="mb-4">
          <div className="text-4xl font-bold text-blue-500 mb-2">
            Predict Department
          </div>
          <p className="text-gray-600 text-lg">
            Describe your medical problem, and I will suggest the right department for you.
          </p>
        </div>
